...
const Home3 = () => {
  ...
  const heroDataNew = {
    imgAuthor: heroData.homeThreeHero?.bgImgLink,
    bgImgLink: user?.about?.avatar?.url,
    text: user?.about?.description,
    title: `Hi, I am <span>${formattedTitle}</span>`,
  };
  console.log(heroData.homeThreeHero,"herodatanew",heroDataNew);
  const services = [
    {
      delay: "200",
      duration: "500",
 ...
 const newSocialData=user.social_handles.map((social)=>({
  ...
  console.log(heroData.homeThreeHero,"first",heroDataNew);
  return (
    <>
      <Hero3 data={heroDataNew} socialData={socialData2} />
